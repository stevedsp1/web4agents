...
Chaque crawler a un user-agent distinct. Vous pouvez autoriser ou bloquer par crawler dans votre [robots.txt](/fr/docs/robots-txt). Pour une liste à jour et les bonnes pratiques, voir le [guide robots.txt](/fr/docs/robots-txt) et le [guide sur l’indexation LLM](/fr/docs/llm-indexing).
